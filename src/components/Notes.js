    ...
    return (
        <div className='container my-3'>
                ...
                <div className="modal-dialog">
                    <div className="modal-content modal-design">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length < 5 || note.edescription.length < 5} onClick={handleClick} type="button" className="button-sp btn btn-primary">Update Note</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-2">
                {notes.length === 0 && <img width={200} src={noNotesImage} alt="No notes" />}
            </div>
            {notes.map(note => (
